...
export declare class Playground extends React.PureComponent<Props & ReduxProps, State> {
    ...
    UNSAFE_componentWillReceiveProps(nextProps: Props & ReduxProps): void;
...
declare const _default: import("react-redux").ConnectedComponent<typeof Playground, Pick<React.ClassAttributes<Playground> & Props & ReduxProps, "headers" | "endpoint" | "shareUrl" | "fixedEndpoint" | "configString" | "schema" | "share" | "ref" | "getRef" | "key" | "shareEnabled" | "isApp" | "subscriptionEndpoint" | "projectId" | "onSuccess" | "isEndpoint" | "onChangeEndpoint" | "onChangeSubscriptionsEndpoint" | "graphqlConfig" | "onSaveSettings" | "onChangeSettings" | "onSaveConfig" | "onChangeConfig" | "onUpdateSessionCount" | "config" | "configIsYaml" | "canSaveConfig" | "fixedEndpoints" | "configPath" | "createApolloLink" | "workspaceName">>;
